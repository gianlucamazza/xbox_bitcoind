...
| Console package | `GianlucaMazza.xboxbitcoind` **0.1.0.10017** (WithCore, release **v0.1.2**) |
| Screenshot | [assets/screenshot-console.png](assets/screenshot-console.png) (0.1.0.75 capture; refresh optional) |
