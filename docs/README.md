...
| Console package | `GianlucaMazza.xboxbitcoind` **0.1.0.75** (WithCore, tip-age UI) |
| Screenshot | [assets/screenshot-console.png](assets/screenshot-console.png) (live 0.1.0.75) |
